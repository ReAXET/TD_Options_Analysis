...
description = """
td_options_analysis API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="td_options_analysis",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://td_options_analysis.com/terms/",
    contact={
        "name": "ReAXET",
        "url": "http://td_options_analysis.com/contact/",
        "email": "ReAXET@td_options_analysis.com",
    },
    license_info={
        "name": "The Unlicense",
