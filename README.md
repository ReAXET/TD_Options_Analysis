...
- 🎯 Entry points to execute your program using `python -m <td_options_analysis>` or `$ td_options_analysis` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/ReAXET/TD_Options_Analysis/branch/main/graph/badge.svg?token=TD_Options_Analysis_token_here)](https://codecov.io/gh/ReAXET/TD_Options_Analysis)
[![CI](https://github.com/ReAXET/TD_Options_Analysis/actions/workflows/main.yml/badge.svg)](https://github.com/ReAXET/TD_Options_Analysis/actions/workflows/main.yml)

Awesome td_options_analysis created by ReAXET

## Install

from source
```bash
git clone https://github.com/ReAXET/TD_Options_Analysis td_options_analysis
cd td_options_analysis
make install
```
...
```bash
pip install td_options_analysis
```

## Executing

```bash
$ td_options_analysis run --port 8080
```

or

```bash
python -m td_options_analysis run --port 8080
```

or

```bash
$ uvicorn td_options_analysis:app
```

## CLI

```bash
❯ td_options_analysis --help
Usage: td_options_analysis [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ td_options_analysis create-user --help
Usage: td_options_analysis create-user [OPTIONS] USERNAME PASSWORD
...
```bash
td_options_analysis create-user admin admin --superuser
```
...
Run with `td_options_analysis run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `td_options_analysis create-user`.
...
-----------------------------------------------------
td_options_analysis/__init__.py              4      0   100%
td_options_analysis/app.py                  16      1    94%
td_options_analysis/cli.py                  21      0   100%
td_options_analysis/config.py                5      0   100%
td_options_analysis/db.py                   10      0   100%
td_options_analysis/models/__init__.py       0      0   100%
td_options_analysis/models/content.py       47      1    98%
td_options_analysis/routes/__init__.py      11      0   100%
td_options_analysis/routes/content.py       52     25    52%
td_options_analysis/routes/security.py      15      1    93%
td_options_analysis/routes/user.py          52     26    50%
td_options_analysis/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in td_options_analysis/default.toml.
